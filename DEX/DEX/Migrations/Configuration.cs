    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DEX.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(DEX.Models.ApplicationDbContext context)
        {
            ...
            context.Contacts.AddOrUpdate(
                c => c.Name,
                new Contact { Name = "Jake Erikson", Title ="Technology Recruiter", Company = context.Companies.FirstOrDefault(c => c.Name == "Slalom Consluting"),
                Email = "jake@somewhere.com", PhoneNumber = "206-000-0000"},
                new Contact { Name = "Eric Kim", Title = "Technical Recruiter", Company = context.Companies.FirstOrDefault(c => c.Name == "Microsoft"),
                Email = "eric@ms.com", PhoneNumber = "206-111-1111"},
                new Contact { Name = "Ben Amor", Title="CTO", Company = context.Companies.FirstOrDefault(c => c.Name == "Xero"),
                Email = "ben@somewhere.com", PhoneNumber = "04-000-000"}  
            );
            context.SaveChanges();
        }
    }
