...
function contactList(data) {
    ...
    var html = '<div class="contact-container">' +
                    ...
                    '<div class="btn btn-group col-xs-12 col-sm-4 col-sm-offset-2" role="group" aria-label="Contact Control Buttons">' +
                        '<button type="button" class="btn btn-primary btn-circle"><i class="glyphicon glyphicon-envelope"></i></button>' +
                        '<button type="button" class="btn btn-primary btn-circle"><span class="glyphicon glyphicon-phone-alt"></span> </button>' +
                        '<button type="button" class="btn btn-primary btn-circle"><span class="glyphicon glyphicon-facetime-video"></span> </button>' +
                        '<button type="button" class="btn btn-primary btn-circle"><span class="glyphicon glyphicon-pencil"></span> </button>' +
